...
const TypingEffect = ({ prompts, prefix="", textStyle, typeStyle, typingSpeed = 100, pauseTime = 2000 }) => {
  ...
  return <div className={styles.effect} style={textStyle}>
        <span>{prefix + ""}</span>
        <span style={typeStyle}>{currentText + ""}</span>
